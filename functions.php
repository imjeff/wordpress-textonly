<?php
// 主题设置
if (!function_exists('textonly_setup')) :
	function textonly_setup()
	{
    ...
    add_action('after_setup_theme', 'textonly_setup');
endif;

// 主题样式
if ( ! function_exists( 'textonly_load_style' ) ) :
	function textonly_load_style() {
		wp_enqueue_style( 'textonly-style', get_stylesheet_uri(), array(), '20240618' );
	}
	add_action( 'wp_enqueue_scripts', 'textonly_load_style' );
endif;
